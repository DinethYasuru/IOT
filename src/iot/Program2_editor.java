 ...
 * @author Dineth
 */
public class Program2_editor extends javax.swing.JFrame {

    /**
     * Creates new form Editor
     */
    public Program2_editor() throws IOException {
        getData();
        initComponents();
    }
    ...
    String q1_status = null, q1_sd = null, q1_rt = null;
    String q2_status = null, q2_sd = null, q2_rt = null;
    String q3_status = null, q3_sd = null, q3_rt = null;
    String q4_status = null, q4_sd = null, q4_rt = null;
    String q5_status = null, q5_sd = null, q5_rt = null;
    String q6_status = null, q6_sd = null, q6_rt = null;
    String q7_status = null, q7_sd = null, q7_rt = null;
    String pulse = null;
    int int_pulse = 0;
    /**
     *
    ...
    public void getData() throws IOException {
        ...
        prop.load(reader);
        this.q1_status = prop.getProperty("q1_status");
        this.q1_sd = prop.getProperty("q1_sd");
        this.q1_rt = prop.getProperty("q1_rt");

        this.q2_status = prop.getProperty("q2_status");
        this.q2_sd = prop.getProperty("q2_sd");
        this.q2_rt = prop.getProperty("q2_rt");

        this.q3_status = prop.getProperty("q3_status");
        this.q3_sd = prop.getProperty("q3_sd");
        this.q3_rt = prop.getProperty("q3_rt");

        this.q4_status = prop.getProperty("q4_status");
        this.q4_sd = prop.getProperty("q4_sd");
        this.q4_rt = prop.getProperty("q4_rt");

        this.q5_status = prop.getProperty("q5_status");
        this.q5_sd = prop.getProperty("q5_sd");
        this.q5_rt = prop.getProperty("q5_rt");

        this.q6_status = prop.getProperty("q6_status");
        this.q6_sd = prop.getProperty("q6_sd");
        this.q6_rt = prop.getProperty("q6_rt");

        this.q7_status = prop.getProperty("q7_status");
        this.q7_sd = prop.getProperty("q7_sd");
        this.q7_rt = prop.getProperty("q7_rt");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
            ...
            System.out.println(q1_status);
            if (this.q1_status.equals("1")) {
    ...
    private void jToggleButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jToggleButton1MouseClicked
        ...
        if (jToggleButton1.isSelected()) {
            ...
            jToggleButton1.setBackground(new java.awt.Color(0, 102, 204));
            try {
                this.saveData("q1_status", "1");
            } catch (IOException ex) {
                Logger.getLogger(Program2_editor.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jToggleButton1MouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_jToggleButton1MouseWheelMoved
        ...
        if (!jToggleButton1.isSelected()) {
            try {
                ...
                this.q1_status = "1";
                this.q1_sd = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Starting Delay in miliseconds", "Relay 1 Programmer", JOptionPane.INFORMATION_MESSAGE));
                this.q1_rt = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Run time in miliseconds", "Relay 1 Programmer", JOptionPane.INFORMATION_MESSAGE));
                prop.setProperty("q1_status", String.valueOf(this.q1_status));
                prop.setProperty("q1_sd", String.valueOf(this.q1_sd));
                prop.setProperty("q1_rt", String.valueOf(this.q1_rt));
                prop.store(out, null);
                out.close();
            } catch (IOException ex) {
                Logger.getLogger(Program2_editor.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jToggleButton2MouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_jToggleButton2MouseWheelMoved
        if (!jToggleButton2.isSelected()) {
            try {
                ...
                this.q2_status = "1";
                this.q2_sd = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Starting Delay in miliseconds", "Relay 2 Programmer", JOptionPane.INFORMATION_MESSAGE));
                this.q2_rt = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Run time in miliseconds", "Relay 2 Programmer", JOptionPane.INFORMATION_MESSAGE));
                prop.setProperty("q2_status", String.valueOf(this.q2_status));
                prop.setProperty("q2_sd", String.valueOf(this.q2_sd));
                prop.setProperty("q2_rt", String.valueOf(this.q2_rt));
                prop.store(out, null);
                out.close();
            } catch (IOException ex) {
                Logger.getLogger(Program2_editor.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jToggleButton3MouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_jToggleButton3MouseWheelMoved
       if (!jToggleButton3.isSelected()) {
            try {
                ...
                this.q3_status = "1";
                this.q3_sd = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Starting Delay in miliseconds", "Relay 3 Programmer", JOptionPane.INFORMATION_MESSAGE));
                this.q3_rt = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Run time in miliseconds", "Relay 3 Programmer", JOptionPane.INFORMATION_MESSAGE));
                prop.setProperty("q3_status", String.valueOf(this.q3_status));
                prop.setProperty("q3_sd", String.valueOf(this.q3_sd));
                prop.setProperty("q3_rt", String.valueOf(this.q3_rt));
                prop.store(out, null);
                out.close();
            } catch (IOException ex) {
                Logger.getLogger(Program2_editor.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jToggleButton4MouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_jToggleButton4MouseWheelMoved
       if (!jToggleButton4.isSelected()) {
            try {
                ...
                this.q4_status = "1";
                this.q4_sd = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Starting Delay in miliseconds", "Relay 4 Programmer", JOptionPane.INFORMATION_MESSAGE));
                this.q4_rt = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Run time in miliseconds", "Relay 4 Programmer", JOptionPane.INFORMATION_MESSAGE));
                prop.setProperty("q4_status", String.valueOf(this.q4_status));
                prop.setProperty("q4_sd", String.valueOf(this.q4_sd));
                prop.setProperty("q4_rt", String.valueOf(this.q4_rt));
                prop.store(out, null);
                out.close();
            } catch (IOException ex) {
                Logger.getLogger(Program2_editor.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jToggleButton5MouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_jToggleButton5MouseWheelMoved
       if (!jToggleButton5.isSelected()) {
            try {
                ...
                this.q5_status = "1";
                this.q5_sd = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Starting Delay in miliseconds", "Relay 5 Programmer", JOptionPane.INFORMATION_MESSAGE));
                this.q5_rt = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Run time in miliseconds", "Relay 5 Programmer", JOptionPane.INFORMATION_MESSAGE));
                prop.setProperty("q5_status", String.valueOf(this.q5_status));
                prop.setProperty("q5_sd", String.valueOf(this.q5_sd));
                prop.setProperty("q5_rt", String.valueOf(this.q5_rt));
                prop.store(out, null);
                out.close();
            } catch (IOException ex) {
                Logger.getLogger(Program2_editor.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jToggleButton7MouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_jToggleButton7MouseWheelMoved
       if (!jToggleButton7.isSelected()) {
            try {
                ...
                this.q7_status = "1";
                this.q7_sd = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Starting Delay in miliseconds", "Relay 7 Programmer", JOptionPane.INFORMATION_MESSAGE));
                this.q7_rt = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Run time in miliseconds", "Relay 7 Programmer", JOptionPane.INFORMATION_MESSAGE));
                prop.setProperty("q7_status", String.valueOf(this.q7_status));
                prop.setProperty("q7_sd", String.valueOf(this.q7_sd));
                prop.setProperty("q7_rt", String.valueOf(this.q7_rt));
                prop.store(out, null);
                out.close();
            } catch (IOException ex) {
                Logger.getLogger(Program2_editor.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jToggleButton6MouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_jToggleButton6MouseWheelMoved
        if (!jToggleButton6.isSelected()) {
            try {
                ...
                this.q6_status = "1";
                this.q6_sd = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Starting Delay in miliseconds", "Relay 6 Programmer", JOptionPane.INFORMATION_MESSAGE));
                this.q6_rt = String.valueOf(JOptionPane.showInputDialog(null, "Enter the Run time in miliseconds", "Relay 6 Programmer", JOptionPane.INFORMATION_MESSAGE));
                prop.setProperty("q6_status", String.valueOf(this.q6_status));
                prop.setProperty("q6_sd", String.valueOf(this.q6_sd));
                prop.setProperty("q6_rt", String.valueOf(this.q6_rt));
                prop.store(out, null);
                out.close();
            } catch (IOException ex) {
                Logger.getLogger(Program2_editor.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Program2_editor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Program2_editor().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(Program2_editor.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
